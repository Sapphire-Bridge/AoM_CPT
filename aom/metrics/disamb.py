...
from ..utils import bootstrap_ci, bootstrap_ci_metric, get_logprob_computation_config, logprob_of_continuation_ids
    ...
    *,
    ...
    for label, continuations in choices.items():
        ...
        for cont in continuations:
            cont_ids = _encode_continuation(tokenizer, cont, device=device)
    ...
    for label, continuations in choices.items():
        ...
        for cont in continuations:
            ...
            if isinstance(patch_site, PatchSite):
                logits = forward_with_patched_block_output(
                    model,
                    input_ids=full_ids,
                    site=patch_site,
