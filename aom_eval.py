...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        ...
        type=str,
        default=None,
        help="Dtype: float32, float16, bfloat16 (default: bfloat16 for Qwen, float32 otherwise).",
    )
    p.add_argument(
        "--attn_implementation",
        type=str,
    ...
    p.add_argument("--sae_dtype", type=str, default="float32", help="Dtype for SAE weights/compute (e.g. float32).")
    p.add_argument(
        "--sae_decode_strategy",
        type=str,
